...
const PAGE_META: Record<string, { title:string; sub:string }> = {
  ...
  'cash-voucher':   { title:'Cash Voucher',   sub:'Outgoing cash payments' },
  receipt:          { title:'Receipt',        sub:'Incoming payments received' },
  letterhead:       { title:'Letterhead',     sub:'Official company letterhead' },
  'business-card':  { title:'Business Card',  sub:'Official company business card' },
